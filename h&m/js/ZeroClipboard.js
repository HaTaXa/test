...
!(function (a, b) {
	...
	var c,
		...
		f = d.navigator,
		g = d.setTimeout,
		h = d.encodeURIComponent,
		i = d.ActiveXObject,
		j = d.Error,
		k = d.Number.parseInt || d.parseInt,
		l = d.Number.parseFloat || d.parseFloat,
		m = d.Number.isNaN || d.isNaN,
		n = d.Math.round,
		o = d.Date.now,
		p = d.Object.keys,
		q = d.Object.defineProperty,
		r = d.Object.prototype.hasOwnProperty,
		s = d.Array.prototype.slice,
		t = (function () {
			var a = function (a) {
				return a;
			};
		...
		w = function (a) {
			...
			if ("object" != typeof a || null == a) b = a;
				...
				b = {};
				for (e in a) r.call(a, e) && (b[e] = w(a[e]));
			}
			return b;
		},
		x = function (a, b) {
		...
		z = function (a) {
			if (a) for (var b in a) r.call(a, b) && delete a[b];
			return a;
		},
		A = function (a, b) {
			if (
		...
		D = function () {
			...
			return b && (a = b.sourceURL || b.fileName || C(b.stack)), a;
		},
		E = function () {
			var a, c, d;
			if (e.currentScript && (a = e.currentScript.src)) return a;
			if (((c = e.getElementsByTagName("script")), 1 === c.length))
				return c[0].src || b;
			if ("readyState" in c[0])
				for (d = c.length; d--; )
					if ("interactive" === c[d].readyState && (a = c[d].src)) return a;
			return "loading" === e.readyState && (a = c[c.length - 1].src)
				? a
				: (a = D())
				? a
				: b;
		...
		O = function (a) {
			...
			{
				if ("string" != typeof a || !a) return w(N);
				if (r.call(N, a)) return N[a];
			}
		},
		P = function () {
			return {
				...
				flash: y(H, ["bridge"]),
				zeroclipboard: { version: Eb.version, config: Eb.config() },
			};
		},
		Q = function () {
			...
			if (e && e.length) {
				for (c = 0, d = e.length; d > c; c++)
					(a = e[c].replace(/^on/, "")),
						...
						J[a] || (J[a] = []),
						J[a].push(b);
				if ((f.ready && H.ready && Eb.emit({ type: "ready" }), f.error)) {
					var g = [
						"disabled",
						"outdated",
						"unavailable",
					...
					for (c = 0, d = g.length; d > c; c++)
						if (H[g[c]] === !0) {
							Eb.emit({ type: "error", name: "flash-" + g[c] });
							break;
						}
				}
			}
		...
		U = function (a) {
			...
			return (
				(a = cb(a)),
				a && !ib(a)
					? "ready" === a.type && H.overdue === !0
						? Eb.emit({ type: "error", name: "flash-overdue" })
						: ((b = v({}, a)),
						  hb.call(this, b),
						  "copy" === a.type &&
								((d = ob(K)), (c = d.data), (L = d.formatMap)),
						  c)
					: void 0
			);
		},
		V = function () {
			if (
				...
				!Eb.isFlashUnusable() && null === H.bridge)
			) {
				...
				"number" == typeof a &&
					...
					g(function () {
						"boolean" != typeof H.deactivated && (H.deactivated = !0),
							H.deactivated === !0 &&
								Eb.emit({ type: "error", name: "flash-deactivated" });
					}, a),
					(H.overdue = !1),
					mb();
			}
		...
		W = function () {
			Eb.clearData(), Eb.blur(), Eb.emit("destroy"), nb(), Eb.off();
		},
		X = function (a, b) {
			var c;
		...
		Y = function (a) {
			"undefined" == typeof a
				? (z(K), (L = null))
				: "string" == typeof a && r.call(K, a) && delete K[a];
		},
		Z = function (a) {
			return "undefined" == typeof a
				? w(K)
				: "string" == typeof a && r.call(K, a)
				? K[a]
				: void 0;
		},
		$ = function (a) {
			if (a && 1 === a.nodeType) {
				...
				var e = N.forceHandCursor === !0 || "pointer" === xb(a, "cursor");
				Bb(e), Ab();
			}
		},
		_ = function () {
			...
			a &&
				...
				(a.style.width = "1px"),
				(a.style.top = "1px")),
				c && (wb(c, N.hoverClass), wb(c, N.activeClass), (c = null));
		},
		ab = function () {
			return c || null;
		},
		bb = function (a) {
			return (
				"string" == typeof a && a && /^[A-Za-z][A-Za-z0-9_:\-\.]*$/.test(a)
			);
		},
		cb = function (a) {
			var b;
			if (
				...
				var d = M[a.type];
				return (
					"error" === a.type && a.name && d && (d = d[a.name]),
					d && (a.message = d),
					"ready" === a.type && v(a, { target: null, version: H.version }),
					"error" === a.type &&
						(/^flash-(disabled|outdated|unavailable|deactivated|overdue)$/.test(
							a.name
						) && v(a, { target: null, minimumVersion: I }),
						/^flash-(outdated|unavailable|deactivated|overdue)$/.test(a.name) &&
							v(a, { version: H.version })),
					"copy" === a.type &&
						(a.clipboardData = {
							setData: Eb.setData,
							clearData: Eb.clearData,
						}),
					"aftercopy" === a.type && (a = pb(a, L)),
					a.target && !a.relatedTarget && (a.relatedTarget = db(a.target)),
					(a = eb(a))
				);
			}
		},
					...
					for (g = 0, h = f.length; h > g; g++)
						(i = f[g]),
							...
							"object" == typeof i &&
								...
								((j = i), (i = i.handleEvent)),
							"function" == typeof i && ((k = v({}, a)), gb(i, j, [k], b));
				}
				return this;
			}
		},
		ib = function (a) {
			...
			switch (a.type) {
				...
				case "copy":
					...
					break;
				case "aftercopy":
					Eb.clearData(), b && b !== ub() && b.focus && b.focus();
					break;
				case "_mouseover":
					Eb.focus(b),
						N.bubbleEvents === !0 &&
							...
							(b &&
								...
								!A(a.relatedTarget, b) &&
								jb(
									v({}, a, { type: "mouseenter", bubbles: !1, cancelable: !1 })
								),
							jb(v({}, a, { type: "mouseover" })));
					break;
				case "_mouseout":
					Eb.blur(),
						N.bubbleEvents === !0 &&
							...
							(b &&
								...
								!A(a.relatedTarget, b) &&
								jb(
									v({}, a, { type: "mouseleave", bubbles: !1, cancelable: !1 })
								),
							jb(v({}, a, { type: "mouseout" })));
					break;
				case "_mousedown":
					vb(b, N.activeClass),
						N.bubbleEvents === !0 &&
							d &&
							jb(v({}, a, { type: a.type.slice(1) }));
					break;
				case "_mouseup":
					wb(b, N.activeClass),
						N.bubbleEvents === !0 &&
				...
				case "_click":
				case "_mousemove":
					N.bubbleEvents === !0 && d && jb(v({}, a, { type: a.type.slice(1) }));
			}
			return /^_(?:click|mouse(?:over|out|down|up|move))$/.test(a.type)
				? !0
				: void 0;
		},
		jb = function (a) {
		...
		mb = function () {
			var a,
				...
				c = lb(b);
			if (!b) {
				var f = tb(d.location.host, N),
					g = "never" === f ? "none" : "all",
					h = rb(N),
					i = N.swfPath + qb(N.swfPath, N);
				c = kb();
				var j = e.createElement("div");
				c.appendChild(j), e.body.appendChild(c);
		...
		nb = function () {
			...
			if (a) {
				var b = lb(a);
				b &&
					("activex" === H.pluginType && "readyState" in a
		...
		rb = function (a) {
			...
			return (
				i.length && (g += "trustedOrigins=" + h(i.join(","))),
				a.forceEnhancedClipboard === !0 &&
					(g += (g ? "&" : "") + "forceEnhancedClipboard=true"),
				"string" == typeof a.swfObjectId &&
					a.swfObjectId &&
					(g += (g ? "&" : "") + "swfObjectId=" + h(a.swfObjectId)),
				g
			);
		},
		sb = function (a) {
		...
		xb = function (a, b) {
			...
			return "cursor" !== b || (c && "auto" !== c) || "A" !== a.nodeName
				? c
				: "pointer";
		},
		yb = function () {
			var a,
				...
				d = 1;
			return (
				"function" == typeof e.body.getBoundingClientRect &&
		...
		zb = function (a) {
			...
			if (a.getBoundingClientRect) {
				...
				"pageXOffset" in d && "pageYOffset" in d
					? ((c = d.pageXOffset), (f = d.pageYOffset))
					: ((g = yb()),
		...
		Bb = function (a) {
			H.ready === !0 &&
				(H.bridge && "function" == typeof H.bridge.setHandCursor
					? H.bridge.setHandCursor(a)
					: (H.ready = !1));
		},
		Cb = function (a) {
		...
		Db = function (a) {
			...
			if (f.plugins && f.plugins.length)
				(e = f.plugins["Shockwave Flash"]),
					d(e),
					f.plugins["Shockwave Flash 2.0"] && ((i = !0), (m = "2.0.0.11"));
	...
	var Eb = function () {
		return this instanceof Eb
			? void (
					"function" == typeof Eb._createClient &&
					Eb._createClient.apply(this, u(arguments))
			  )
			: new Eb();
	};
	q(Eb, "version", {
		...
		(Eb.clearData = function () {
			return Y.apply(this, u(arguments));
		}),
		(Eb.getData = function () {
			return Z.apply(this, u(arguments));
		}),
		(Eb.focus = Eb.activate = function () {
			return $.apply(this, u(arguments));
		}),
		(Eb.blur = Eb.deactivate = function () {
			return _.apply(this, u(arguments));
		}),
		(Eb.activeElement = function () {
			return ab.apply(this, u(arguments));
		});
	var Fb = 0,
		Gb = {},
		Hb = 0,
	...
	var Kb = function (a) {
			var b = this;
			(b.id = "" + Fb++),
				(Gb[b.id] = { instance: b, elements: [], handlers: {} }),
				a && b.clip(a),
				Eb.on("*", function (a) {
					return b.emit(a);
				}),
				Eb.on("destroy", function () {
					b.destroy();
				}),
				Eb.create();
		},
		Lb = function (a, b) {
			var c,
				...
				e,
				f = {},
				g = Gb[this.id] && Gb[this.id].handlers;
			if ("string" == typeof a && a) e = a.toLowerCase().split(/\s+/);
			else if ("object" == typeof a && a && "undefined" == typeof b)
				for (c in a)
					r.call(a, c) &&
			...
			if (e && e.length) {
				for (c = 0, d = e.length; d > c; c++)
					(a = e[c].replace(/^on/, "")),
						...
						g[a].push(b);
				if (
					(f.ready && H.ready && this.emit({ type: "ready", client: this }),
					f.error)
				) {
					var h = [
						"disabled",
		...
		Mb = function (a, b) {
			var c,
				...
				f,
				g,
				h = Gb[this.id] && Gb[this.id].handlers;
		...
		Nb = function (a) {
			var b = null,
				c = Gb[this.id] && Gb[this.id].handlers;
			return (
				c &&
					(b = "string" == typeof a && a ? (c[a] ? c[a].slice(0) : []) : w(c)),
				b
			);
		},
		Ob = function (a) {
		...
		Pb = function (a) {
			...
			for (var b = 0; b < a.length; b++)
				if (r.call(a, b) && a[b] && 1 === a[b].nodeType) {
					a[b].zcClippingId
						? -1 === Ib[a[b].zcClippingId].indexOf(this.id) &&
						  Ib[a[b].zcClippingId].push(this.id)
						: ((a[b].zcClippingId = "zcClippingId_" + Hb++),
						  (Ib[a[b].zcClippingId] = [this.id]),
						  N.autoActivate === !0 && Wb(a[b]));
					var c = Gb[this.id] && Gb[this.id].elements;
		...
		Sb = function () {
			this.unclip(), this.off(), delete Gb[this.id];
		},
		Tb = function (a) {
			if (!a || !a.type) return !1;
			if (a.client && a.client !== this) return !1;
			var b = Gb[this.id] && Gb[this.id].elements,
				c = !!b && b.length > 0,
		...
		Ub = function (a) {
			if ("object" == typeof a && a && a.type) {
				var b = fb(a),
					c = (Gb[this.id] && Gb[this.id].handlers["*"]) || [],
					e = (Gb[this.id] && Gb[this.id].handlers[a.type]) || [],
					f = c.concat(e);
				if (f && f.length) {
					var g,
						h,
		...
		Vb = function (a) {
			return (
				"string" == typeof a && (a = []), "number" != typeof a.length ? [a] : a
			);
		},
		Wb = function (a) {
			if (a && 1 === a.nodeType) {
		...
		Xb = function (a) {
			if (a && 1 === a.nodeType) {
				var b = Jb[a.zcClippingId];
				if ("object" == typeof b && b) {
					for (
						var c,
							d,
							e = ["move", "leave", "enter", "out", "over"],
							f = 0,
							g = e.length;
						g > f;
						f++
					...
					delete Jb[a.zcClippingId];
				}
			}
		};
	(Eb._createClient = function () {
		Kb.apply(this, u(arguments));
	}),
		(Eb.prototype.on = function () {
			return Lb.apply(this, u(arguments));
		}),
		(Eb.prototype.off = function () {
			return Mb.apply(this, u(arguments));
		}),
		(Eb.prototype.handlers = function () {
			return Nb.apply(this, u(arguments));
		}),
		(Eb.prototype.emit = function () {
			return Ob.apply(this, u(arguments));
		}),
		(Eb.prototype.clip = function () {
			return Pb.apply(this, u(arguments));
		}),
		(Eb.prototype.unclip = function () {
			return Qb.apply(this, u(arguments));
		}),
		(Eb.prototype.elements = function () {
			return Rb.apply(this, u(arguments));
		}),
		(Eb.prototype.destroy = function () {
			return Sb.apply(this, u(arguments));
		}),
		(Eb.prototype.setText = function (a) {
			return Eb.setData("text/plain", a), this;
		}),
		(Eb.prototype.setHtml = function (a) {
			return Eb.setData("text/html", a), this;
		}),
		(Eb.prototype.setRichText = function (a) {
			return Eb.setData("application/rtf", a), this;
		}),
		(Eb.prototype.setData = function () {
			return Eb.setData.apply(this, u(arguments)), this;
		}),
		(Eb.prototype.clearData = function () {
			return Eb.clearData.apply(this, u(arguments)), this;
		}),
		(Eb.prototype.getData = function () {
			return Eb.getData.apply(this, u(arguments));
		}),
